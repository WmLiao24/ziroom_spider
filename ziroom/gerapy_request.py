...
class PyppeteerRequest(Request):
    ...
    def __init__(self, url, callback=None, wait_until=None, wait_for=None, script=None, before_actions=None, actions=None, proxy=None,
        ...
        self.before_actions = pyppeteer_meta.get('before_actions') if pyppeteer_meta.get(
            'before_actions') is not None else before_actions
